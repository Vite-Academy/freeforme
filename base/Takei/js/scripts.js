			...
			$carousels.each( function() {
				$(this).owlCarousel({
					...
					dots: true,
					 lazyLoad: true,
					autoHeight: true,
					navText: ['<svg xmlns="http://www.w3.org/2000/svg" width="25" height="17" fill="var(--color-white)" viewBox="0 0 32 17"><path id="slider-prev" data-name="Slider Prev" class="slider_arrow_path" d="M8.158,0.007L8.835,0.685,1.5,8.019H32V8.979H1.5l7.338,7.334-0.677.679L0,8.839V8.16Z"></path></svg>', '<svg xmlns="http://www.w3.org/2000/svg" width="25" height="17"  fill="var(--color-white)" viewBox="0 0 32 17"><path id="slider-next" data-name="Slider Next" class="slider_arrow_path" d="M23.842,0.007l-0.677.678L30.5,8.019H0V8.979H30.5l-7.338,7.334,0.677,0.679L32,8.839V8.16Z"></path></svg>'],
					smartSpeed: 500,
					responsive: {
						0 : {
					        items: 1,
